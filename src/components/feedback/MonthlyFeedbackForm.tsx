      ...
      <Card className="bg-gradient-to-br from-white to-blue-50 border-0 shadow-lg">
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) => setFormData(prev => ({ ...prev, performance_rating: value }))}
                  >
                    <SelectTrigger className="rounded-xl">
                      <SelectValue placeholder="Select rating" />
                    </SelectTrigger>
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    placeholder="Describe your main achievements and milestones"
                    rows={3}
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    className="rounded-xl border-gray-200"
                    placeholder="Which learning objectives did you meet this month?"
                    rows={3}
                  />
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    className="rounded-xl border-gray-200"
                    placeholder="Describe the mentorship and support you received"
                    rows={3}
                  />
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    onChange={(e) => setFormData(prev => ({ ...prev, supervisor_feedback: e.target.value }))}
                    className="rounded-xl border-gray-200"
                    placeholder="Any comments from your supervisor"
                    rows={3}
                  />
                </div>
              </div>
            ...
            <Button 
              type="submit" 
              disabled={loading || (existingSubmission?.status === 'submitted')}
